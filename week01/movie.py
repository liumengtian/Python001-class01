...
# 电影名称
# film_name = selector.xpath('/div')
    # print(f'电影名称: {film_name}')

# 电影类型
film_type = selector.xpath('//div[@class="movie-hover-info"][1]')
    # print(f'电影类型: {film_type}')

# 上映日期
plan_date = selector.xpath('//div[@class="movie-hover-title movie-hover-brief"]/text()')
# print(f'上映日期: {plan_date}')

init_tuple = [(film_type, plan_date)]
print(init_tuple)
